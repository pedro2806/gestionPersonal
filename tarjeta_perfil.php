...
<div class="card shadow mb-4 border-left-primary overflow-hidden">
    <div class="card-body bg-light p-4">
        <div class="row align-items-center">
            <div class="col-auto text-center border-right pr-md-4">
                <div class="position-relative d-inline-block">
                    <div class="p-2 bg-white rounded-circle shadow-sm border"><i class="fas fa-user-tie fa-4x text-gray-400 p-2"></i></div>
                    <span class="position-absolute bottom-0 end-0 p-2 bg-success border border-white rounded-circle"></span>
                </div>
                <div class="mt-2 text-xs font-weight-bold text-success text-uppercase" id="tarjeta_estatus">Activo</div>
            </div>
            <div class="col pl-md-4">
                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1" style="letter-spacing: 1px;">Ecosistema de Control Documental / Expediente Activo</div>
